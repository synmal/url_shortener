  ...
  describe ".call" do
    context "with a valid URL" do
      it "creates a target URL and short URL" do
        result = described_class.call("https://example.com/page")
      ...
      it "removes URL fragments" do
        result = described_class.call("https://example.com/page#section")
    ...
    context "with invalid input" do
      it "raises on blank URL" do
        expect { described_class.call("") }.to raise_error(ArgumentError, /cannot be blank/)
        expect { described_class.call("  ") }.to raise_error(ArgumentError, /cannot be blank/)
      end

      it "raises on missing scheme" do
        expect { described_class.call("example.com") }.to raise_error(ArgumentError, /Invalid URL/)
      end

      it "raises on invalid scheme" do
        expect { described_class.call("ftp://example.com") }.to raise_error(ArgumentError, /Invalid URL/)
      end

      it "raises on malformed URL" do
        expect { described_class.call("not a url") }.to raise_error(ArgumentError)
      end
    end
    ...
    context "slug collision handling" do
      ...
      it "raises after max retries exhausted" do
        ...
        expect { described_class.call("https://example.com") }.to raise_error(ArgumentError, /Failed to generate unique slug/)
      end
    end
